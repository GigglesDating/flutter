...
class VideoAnalytics {
  ...
  factory VideoAnalytics.fromJson(Map<String, dynamic> json) {
    return VideoAnalytics(
      ...
      dropOffPoints: (json['drop_off_points'] as Map<String, dynamic>?)?.map(
      ...
      averageLoadTime:
          Duration(milliseconds: json['average_load_time'] as int? ?? 0),
    );
  }
  ...
  Map<String, dynamic> toJson() => {
        ...
        'drop_off_points':
            dropOffPoints.map((k, v) => MapEntry(k.toString(), v)),
        ...
        'interaction_points':
            interactionPoints.map((k, v) => MapEntry(k.toString(), v)),
        'buffer_events': bufferEvents,
        'quality_switches': qualitySwitches,
        'network_type_playback':
            networkTypePlayback.map((k, v) => MapEntry(k, v.inMilliseconds)),
