...
class SnipParser {
  ...
  // Cache management
  static void _addToCache<T>(String key, T data,
  ...
  static Map<String, dynamic> _handleSnipParseError(
    Map<String, dynamic> data,
  ) {
    try {
      // Attempt to salvage partial data
  ...
  static Map<String, dynamic> _parseSnipResponseSync(
    ...
    try {
      ...
      final snipsData = data['data'] as Map<String, dynamic>;
      final snips = (snipsData['snips'] as List)
