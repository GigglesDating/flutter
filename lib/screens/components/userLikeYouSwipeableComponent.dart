...
class Userlikeyouswipeablecomponent extends StatefulWidget {
  @override
  _Userlikeyouswipeablecomponent createState() => _Userlikeyouswipeablecomponent();
}
class _Userlikeyouswipeablecomponent extends State<Userlikeyouswipeablecomponent> {
