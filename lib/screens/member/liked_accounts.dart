                    ...
                    Expanded(
                      child: GridView.builder(
                        ...
                        itemBuilder: (context, index) => Dismissible(
                          ...
                          onDismissed: (direction) {
                            if (direction == DismissDirection.endToStart) {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const Placeholder(), // Replace with your screen
                                ),
                              );
                          ...
                          background: Container( // Right swipe background
                            decoration: BoxDecoration(
                          ...
                          secondaryBackground: Container( // Left swipe background
                            decoration: BoxDecoration(
