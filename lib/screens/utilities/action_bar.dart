...
class ActionBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: orientation == ActionBarOrientation.vertical
          ? Column(
              children: _buildActionButtons(screenWidth, screenHeight),
            )
          : Row(
              children: _buildActionButtons(screenWidth, screenHeight),
            ),
  ...
  List<Widget> _buildActionButtons(double screenWidth, double screenHeight) {
    final buttons = [
      ...
      SizedBox(
        height: orientation == ActionBarOrientation.vertical
            ? screenHeight * 0.015
            : 0,
        width: orientation == ActionBarOrientation.horizontal
            ? screenWidth * 0.03
            : 0,
      ),
      _buildActionButton(
